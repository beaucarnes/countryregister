...
.run(function ($ionicPlatform, $rootScope, $state, $localStorage, User,
  ...
  $localStorage.walkthrough = true;   //used to skip walkthrough
...
.config(function ($stateProvider, $urlRouterProvider, $ionicConfigProvider,
  ...
  $translateProvider.translations('en', {
    ...
    inputHopText: 'Choose a shop hop *',
    ...
    errorChooseHopText: 'Choose a shop hop',
    ...
    visitedText: 'Places Visited',
    emptyVisitedText: 'No places visited yet',
    addVisitText: 'Add to places visited',
    addedToVisitedText: 'Place visited',
    othersText: 'Others',
    ...
    slide1Text: 'Welcome to The Country Register app!',
  ...
  $translateProvider.translations('es', {
    ...
    inputHopText: 'Select a shop hop *',
    ...
    slide1Text: '¡Bienvenido a Country Register!',
  ...
  $stateProvider
    ...
    .state('app.hops', {
      ...
      views: {
        'menuContent': {
          templateUrl: 'main/templates/hops.html',
    ...
    .state('app.visited', {
      ...
      views: {
        'menuContent': {
          templateUrl: 'main/templates/visited.html',
          controller: 'VisitedListCtrl'
        }
      }
    })
    .state('app.places', {
    ...
    .state('app.hopplaces', {
      url: '/hopplaces/:hopId/:hopTitle',
      views: {
        'menuContent': {
          templateUrl: 'main/templates/hopplaces.html',
          controller: 'HopPlaceListCtrl'
        }
      }
    })
    .state('app.place', {
