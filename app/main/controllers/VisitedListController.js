'use strict';
angular.module('main')
.controller('VisitedListCtrl', function ($scope, $ionicLoading, $state,
  $translate, Toast, GoogleAnalytics, Place) {

  GoogleAnalytics.trackView('Visited List Screen');
  ...
  var loadPlaces = function () {
    ...
    Place.getVisited($scope.params).then(function (places) {
