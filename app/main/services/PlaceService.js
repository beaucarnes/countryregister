...
angular.module('main').factory('Place', function ($q, $localStorage) {
  ...
  var Place = Parse.Object.extend('Place', {
    ...
    all: function (params) {
      ...
      if (params.hopId) {
        ...
        var objHop = new Hop();
        objHop.id = params.hopId;
        query.equalTo('hop', objHop);
      }
    ...
    getVisited: function (params) {
      ...
      query.limit(limit);
      query.equalTo('isApproved', true);
      query.equalTo('visit', Parse.User.current());
    ...
    getHopVisited: function (params) {
      ...
      query.limit(limit);
      query.equalTo('isApproved', true);
      query.equalTo('hopVisit', Parse.User.current());
    ...
    isVisited: function (id) {
      ...
      Parse.Cloud.run('isPlaceVisited', { placeId: id }, {
        success: function (response) {
          defer.resolve(response);
        },
        error: function (error) {
    ...
    isHopVisited: function (id) {

      var defer = $q.defer();

      Parse.Cloud.run('isPlaceHopVisited', { placeId: id }, {
        success: function (response) {
          defer.resolve(response);
        },
        error: function (error) {
    ...
    visit: function (id) {
      ...
      Parse.Cloud.run('visitPlace', { placeId: id }, {
        success: function (response) {
          defer.resolve(response);
        },
        error: function (error) {
    ...
    hopVisit: function (id) {

      var defer = $q.defer();

      Parse.Cloud.run('hopVisitPlace', { placeId: id }, {
        success: function (response) {
          defer.resolve(response);
        },
        error: function (error) {
  ...
  Object.defineProperty(Place.prototype, 'hop', {
    get: function () {
      return this.get('hop');
    },
    set: function (value) {
